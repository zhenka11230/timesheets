...
class BulletinAcceptance extends DbObject
{
	public static $tableName = "tblBulletinAcceptances";
	public $exists = false;
	...
	public function getBulletinAcceptances($args=array())
	{
		global $db;
