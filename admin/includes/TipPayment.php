...
class TipPayment extends DbObject
{
	public static $tableName = "tblTipPayments";
	public $exists = false;
	...
	/** [[Column=lngTipID, DataType=int, Description=LngTipID]]*/
	public $lngTipID;
	...
	public function getTipPayments($args=array())
	{
		global $db;
		...
		$query = "SELECT * 
			...
			WHERE 1=1 
				...
				".(@$args['lngTipID'] != '' ? " AND lngTipID={$args['lngTipID']} " : "")."
