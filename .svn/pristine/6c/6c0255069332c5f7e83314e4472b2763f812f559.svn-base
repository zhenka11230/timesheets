...
<body style="background-color:#FFF7EF;">
	<div style="background:#5F0000;padding:2px;">
		<div style="background:#5F0000;padding:2px;" class="noprint">		
		...
		<div style="float:right;width:34%;padding-right:10px;">
			<input type="button" class="button btn-print" style="width:82px;" onclick="window.print();" value="Print">
		</div>
