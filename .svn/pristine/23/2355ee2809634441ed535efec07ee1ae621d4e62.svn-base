...
$fdf_file = fopen("./temp/$file_id.fdf", "w");
...
exec("start java -classpath \".;itextpdf-5.1.3.jar\" StreamPdf low_res.pdf ./temp/$file_id.fdf ./temp/$file_id.pdf flatten");
readfile("./temp/$file_id.pdf");
